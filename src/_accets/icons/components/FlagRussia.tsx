...
const SvgFlagRussia = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path fill='url(#Flag_Russia_svg__a)' d='M0 0h24v24H0z' />
    <defs>
      <pattern id='Flag_Russia_svg__a' width={1} height={1} patternContentUnits='objectBoundingBox'>
        <use xlinkHref='#Flag_Russia_svg__b' transform='scale(.01389)' />
      </pattern>
      <image
